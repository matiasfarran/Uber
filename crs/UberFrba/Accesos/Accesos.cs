...
namespace UberFrba.Accesos
{
    public class Access
    {
        private SqlConnection cnn;
        private SqlTransaction tx;
        private string connectionString = "Data Source=AR-ITS-MF\\SQLSERVER2012;Initial Catalog=GD1C2017;User ID=sa;Password=gestiondedatos";
